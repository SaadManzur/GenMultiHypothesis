...
class LinearModel(object):
  ...
  def get_all_batches(self, data_x, data_y, camera_frame, training=True):
      ...
      if isinstance(data_x, dict):
        ...
        # print("Computing number of data")
        n = data_x.shape[0]
      ...
      if isinstance(data_x, dict):
        ...
        # print("Copying encoder and decoder")
      ...
      return encoder_inputs, decoder_outputs # Do not need it now , repre
